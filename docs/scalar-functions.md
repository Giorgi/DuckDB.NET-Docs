...
[!code-csharp[](../code/ScalarFunctionIsPrime.cs#Example)]

> [!NOTE]
> The examples on this page use [Dapper](https://github.com/DapperLib/Dapper) (`connection.Query`) to run the verification queries. Dapper is not required to register or use scalar functions.

The API supports zero to four parameters:

[!code-csharp[](../code/ScalarFunctionParameterCounts.cs#Example)]

### Variable Arguments

Variable argument functions receive all inputs as an array. DuckDB allows calling them with any number of arguments:

[!code-csharp[](../code/ScalarFunctionHighLevelVarargs.cs#Example)]
...
[!code-csharp[](../code/ScalarFunctionDynamicTypeName.cs#Example)]
...
[!code-csharp[](../code/ScalarFunctionDynamicTypes.cs#Example)]
...
[!code-csharp[](../code/ScalarFunctionNullableParameter.cs#Example)]
...
[!code-csharp[](../code/ScalarFunctionNullableReference.cs#Example)]
...
[!code-csharp[](../code/ScalarFunctionMixedNullability.cs#Example)]
...
[!code-csharp[](../code/ScalarFunctionLowLevelIsPrime.cs#Example)]
...
[!code-csharp[](../code/ScalarFunctionNonPure.cs#Example)]
...
[!code-csharp[](../code/ScalarFunctionVarargs.cs#Example)]
...
[!code-csharp[](../code/ScalarFunctionAnyInputType.cs#Example)]
...
[!code-csharp[](../code/ScalarFunctionNullHandling.cs#Example)]
